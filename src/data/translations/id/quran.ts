...
export const quranID = {
    ...
    quranBack: "Kembali",
    quranMakkah: "Makkiyah",
    quranMadinah: "Madaniyah",
    quranVerseCount: "Ayat",
    quranPlayVerse: "Putar Ayat",
    quranAddBookmark: "Tandai Ayat",
    quranRemoveBookmark: "Hapus Penanda",
    quranShareVerse: "Bagikan Ayat",
    quranShowTafsir: "Lihat Tafsir",
    quranCloseTafsir: "Tutup Tafsir",
    quranHafizModeOn: "Buka Ayat (Mode Hafalan)",
    quranHafizModeOff: "Tutup Ayat (Mode Hafalan)",

            ...
            <div className="relative min-h-screen pb-16 w-full max-w-4xl mx-auto">
                        ...
                        <div className="flex items-center gap-2 shrink-0">
                            ...
                            {!playingVerseKey && (
                                <Tooltip>
                                    ...
                                    <TooltipContent side="bottom">{t.quranPlaySurah}</TooltipContent>
                                </Tooltip>
                            )}
                            ...
                            {!isSearchOpen && (
                                <Tooltip>
                                    ...
                                    <TooltipContent side="bottom">{t.quranSettingsTitle}</TooltipContent>
                                </Tooltip>
                            )}
                        </div>
                    </div>
                ...
                {isPending && (
                    <div className="fixed top-20 right-4 z-50">
                        <Loader2 className="h-5 w-5 animate-spin text-[rgb(var(--color-primary))]" />
                    </div>
                )}
            </div>
        </TooltipProvider>
